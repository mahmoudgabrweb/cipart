...
class ReturnReasonController extends MainController
{
    public function __construct()
    {
        $this->moduleName = "return_reasons";
        $this->model = ReturnReasons::class;
    }
    ...
    public function load()
    {
        ...
        $records = $this->model::select(['id', "reason", "is_active", 'created_at']);

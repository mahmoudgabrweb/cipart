...
class ManufactureYearController extends MainController
{
    public function __construct()
    {
        $this->moduleName = "manufacture_years";
        $this->model = ManufactureYear::class;
    }
    ...
    public function load()
    {
        ...
        $records = $this->model::select(['id', "year", 'created_at']);
    ...
    public function update(Request $request, int $id): RedirectResponse
    {
        ...
        $updatedArray = ["year" => $request->year];

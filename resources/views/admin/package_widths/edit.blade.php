                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formValidationExamples" class="row g-6" method="POST"
                            ...
                            @method('PUT')
                            <div class="col-md-12">
                                <label class="form-label" for="name_ar">Arabic Package Width<span class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label" for="name_en">English Package Width</label>
